...
//         cy.get('.chakra-button.css-3w8w6m').click();
//         cy.get('header.chakra-modal__header.css-9fgtzh').contains('Partai').click();
...
//         cy.get('.chakra-button.css-3w8w6m').click();
//         cy.get('header.chakra-modal__header.css-9fgtzh').contains('Forum').click();
...
//         cy.get('.chakra-button.css-1e2c6cf')
//             .should('be.visible')
//             .click()
//             .wait(2000).go('back')
//     });
...
//         cy.get('.chakra-button.css-3w8w6m').click();
//         cy.get('header.chakra-modal__header.css-9fgtzh').contains('Login').click();
...
//         cy.get('.chakra-button.css-3w8w6m').click();
//         cy.get('header.chakra-modal__header.css-9fgtzh').contains('Profile').click();
//     });
...
//         cy.get('.chakra-button.css-3w8w6m').click();
//         cy.get('header.chakra-modal__header.css-9fgtzh').contains('Logout').click().wait(3000);
//     });
// });
...
describe('Manage User', () => {
    beforeEach(() => {
        ...
        cy.get('button.chakra-button.css-1wz2fac[aria-label="open menu"]').click();
        cy.get('div.css-15hy375').eq(1).click();
        // cy.get('button.css-a55ue7[aria-label="Close"]').click();
    });
...
//         cy.get('.chakra-button.css-1e2c6cf').click();
