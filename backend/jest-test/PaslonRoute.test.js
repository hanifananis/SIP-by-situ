...
const paslonApi = describe('Paslon API', () => {
    it('should get all paslon', async () => {
        ...
        expect(response.body).toEqual([
            ...
            },
            {
                ...
                "updatedAt": "2023-11-30T03:21:07.988Z",
                "__v": 0
            },
            {
                "_id": "6567ffa3f9f0265bff5276da",
                "capres": "Delete Test Paslon",
                "cawapres": "Delete Paslon",
                "no_urut": 5,
                "misi": [],
                "createdAt": "2023-11-30T03:21:07.693Z",
                "updatedAt": "2023-11-30T03:21:07.693Z",
                "__v": 0
            }
        ]);
    });
    ...
    it('should delete a paslon by ID', async () => {
        const response = await request(app).delete('/paslons/6567ffa3f9f0265bff5276da');
        expect(response.status).toBe(200);
    });
});
