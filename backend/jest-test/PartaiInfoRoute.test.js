...
const partaiAPI = describe('Partai API', () => {
    ...
    //     const response = await request(app).get('/partaiInfos/65656c554f4ac06590bd923f')
    //     expect(response.status).toBe(200)
    //     expect(response.body).toEqual(
    //         {
    //             "_id": "65656c554f4ac06590bd923f",
    ...
    it('should save a new PartaiInfo', async () => {
        ...
        expect(response.body).toEqual(expect.objectContaining({
            "name": expect.stringContaining("Testing Save Partai")
        }))
    })

    // it('should update a PartaiInfo by ID', async () => {
    //     const updatePartaiData = {
    //         "name": "Update Testing Save Partai",
    //         "no_urut": 26,
    //     }
    //     const response = await request(app)
    //         .put('/partaiInfos/6571ee0daa7a551dd1cd1dd2')
    ...
    //     const response = await request(app).delete('/partaiInfos/6571ee0daa7a551dd1cd1dd2')
    //     expect(response.status).toBe(200)
    // })
})
