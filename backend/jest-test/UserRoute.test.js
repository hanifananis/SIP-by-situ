...
const userApi = describe('User API', () => {
  it('should get all users', async () => {
    ...
    expect(response.body).toEqual([
        ...
        {
            "_id": "6564e6e2f97e8c8718db8e3d",
            "name": "Login Test",
            "email": "logintest@gmail.com",
            "no_telp": "1234567890",
            "roles": "user",
            "createdAt": "2023-11-27T18:58:42.988Z",
            "updatedAt": "2023-11-27T18:58:42.988Z",
            "__v": 0
        },
        {
            "_id": "6564eb3b7b595bb6238242d7",
            "name": "Testing Register",
            "email": "register@example.com",
            "no_telp": "1234567890",
            "roles": "user",
            "createdAt": "2023-11-27T19:17:15.877Z",
            "updatedAt": "2023-11-27T19:17:15.877Z",
            "__v": 0
        },
        {
  ...
  it('should update a user by ID', async () => {
    ...
    const response = await request(app)
      .patch('/users/6571e0285e58b11fa9b0ef94')
  ...
  it('should delete a user by ID', async () => {
    const response = await request(app).delete('/users/6572cc6e93534a9bd9b572d0')
    expect(response.status).toBe(200)
  })
})
